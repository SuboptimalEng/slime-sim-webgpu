...
Check out the [demo on my website](https://suboptimaleng.com/slime-sim-webgpu/). It may not
work on mobile devices, so I'd recommend trying it on a desktop computer with the Chrome
browser.
