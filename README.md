...
If you want see this in action, you can checkout a 40-second demo on
...
You can also try the demo on my website. Just know that WebGPU doesn't work
on all devices so you might get an error screen.
